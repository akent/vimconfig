...
hi Constant		term=underline ctermfg=LightGreen guifg=LightGreen	gui=NONE
...
hi Special		term=bold	   ctermfg=LightRed   guifg=#DD44DD
hi Statement	term=bold	   ctermfg=Yellow	  guifg=#ffff00 gui=NONE
hi Type						   ctermfg=LightGreen guifg=#DD4444	gui=bold
hi Error		term=reverse   ctermbg=Red	  ctermfg=White guibg=Red  guifg=White
hi Todo			term=standout  ctermbg=Yellow ctermfg=Black guifg=Blue guibg=Yellow
hi Folded       term=standout  ctermbg=Yellow ctermfg=Black guibg=Black guifg=Yellow
